...
class Network :
    ...
    def backprop(self, x, y, batch_size, learning_rate, label=None):
        ...
        print('Output -> {}\t\tE1 -> {}\t\tdW1 -> {} label -> {}'.format(numpy.round(outputs[0], 4), numpy.round(E1, 4),  numpy.round(dW1, 4),label))
...
if __name__ == '__main__':
    ...
    network.SGD(training_data=train_data, epochs=10, mini_batch_size=5, learning_rate=3)
    # print(network)
